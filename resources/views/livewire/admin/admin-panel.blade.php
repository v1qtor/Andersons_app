<section class="w-full">
                            ...
                            <tr class="hover:bg-neutral-50 dark:hover:bg-zinc-700/40">
                                ...
                                <td class="py-2.5 px-3 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <button wire:click="confirmDeleteBirthdate({{ $bd->id }})" class="text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 transition-colors" title="{{ __('Delete') }}">
    ...
    {{-- Delete Birthday Confirmation --}}
    <flux:modal name="delete-birthdate-modal" :show="$showDeleteBirthdateConfirm" wire:model="showDeleteBirthdateConfirm">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">{{ __('Delete Birthday') }}</flux:heading>
                <flux:subheading>{{ __('Delete the birthday for :name? This cannot be undone.', ['name' => $confirmingDeleteBirthdate?->name]) }}</flux:subheading>
            </div>

            <div class="flex gap-2 justify-end">
                <flux:button variant="ghost" wire:click="closeDeleteBirthdateConfirm">{{ __('Cancel') }}</flux:button>
                <flux:button variant="danger" wire:click="deleteBirthdate">{{ __('Delete') }}</flux:button>
            </div>
        </div>
    </flux:modal>
