    ...
    <div class="w-full max-w-4xl mx-auto flex flex-col gap-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Manage your unavailable periods. You cannot add a period that conflicts with an existing task.</p>
            </div>
            @if(! $showForm)
        ...
        @if($showForm)
            <div class="bg-white dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-700/50 rounded-2xl p-6 shadow-sm">
                <h2 class="text-lg font-semibold text-neutral-800 dark:text-neutral-200 mb-5">New Unavailability Period</h2>
                ...
                <div class="flex items-start justify-between gap-4 py-4 {{ !$loop->last ? 'border-b border-neutral-100 dark:border-neutral-700/50' : '' }}">
                    ...
                    @if($isFuture)
                        <button
                            ...
                            class="shrink-0 text-red-400 hover:text-red-600 dark:text-red-500 dark:hover:text-red-400 transition-colors p-1"
                            title="Delete"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="size-5">
                    ...
                    @else
                        <span class="shrink-0 text-xs text-neutral-400 dark:text-neutral-500 italic mt-1">In progress</span>
                    @endif
                </div>
            @empty
